...
<head>
    ...
    <style>
        ...
        @media screen and (min-device-width: 768px) and (max-device-width: 1199.99px) {
...
<body class="loading" data-layout='{"mode": "light", "width": "fluid", "menuPosition": "fixed", "sidebar": { "color": "light", "size": "default", "showuser": false}, "topbar": {"color": "dark"}, "showRightSidebarOnPageLoad": true}'>
    ...
    <script>
        ...
        function authCheck(responce = '') {
            console.log("run function auth check");
            if (responce && responce != '' && responce == "Unauthorized") {
                console.log("responce not null");
                location.reload();
