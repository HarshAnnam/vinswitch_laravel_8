        ...
        <div class="card text-center">
            ...
            <i class="fa fa-user-secret h1 rounded-circle img-thumbnail1" ></i>
                ...
                <div class="text-start mt-3">
                    ...
                    <p class="text-muted mb-2 font-13"><strong>Full Name :</strong> <span class="ms-2">{{$customer['first_name']}} {{$customer['last_name']}}</span></p>
                
                    <p class="text-muted mb-2 font-13"><strong>Mobile :</strong><span class="ms-2">{{$customer['contact_no']}}</span></p>
                
                    <p class="text-muted font-13"><strong>Address :</strong><span class="ms-2">{{$customer['address']}} </span></p>
                
                    <p class="text-muted mb-1 font-13"><strong>Location :</strong> <span class="ms-2">{{$customer['country']}}</span></p>
                </div>                                    
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="firstname" placeholder="First Name" value="{{$customer['first_name']}}" minlength="3" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-user-alt"></i></span>
                                            <input type="text" class="form-control" id="lastname" placeholder="Last Name" value="{{$customer['last_name']}}" minlength="3" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="email" placeholder="Email" value="{{$customer['email']}}" disabled readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="contact_no" placeholder="Phone" value="{{$customer['contact_no']}}" minlength="10" required>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" id="address" placeholder="Address">{{$customer['address']}}</textarea minlength="5" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="country" placeholder="Country" value="{{$customer['country']}}" disabled readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="state" placeholder="State" value="{{$customer['state']}}" minlength="2" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="city" placeholder="City" value="{{$customer['city']}}" minlength="2" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="postal_code" placeholder="Zipcode" value="{{$customer['postal_code']}}" minlength="6" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="company_name" placeholder="Company Name" value="{{$customer['company_name']}}">
